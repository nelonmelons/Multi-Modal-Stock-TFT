...
Multi-horizon equity prediction remains challenging given noisy targets, regime dependence, and the potential for only small predictive signals.
...
RNN and TFT models predict multiple horizons simultaneously, while tabular models are trained separately for each horizon.
