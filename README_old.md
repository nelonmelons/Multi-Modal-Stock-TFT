...
**Research Paper**: "Benchmarking Transformers and Baselines for Multi-Horizon Stock Return Prediction with Technical and Earnings Features"  
**Conference**: 2025 17th International Conference on Information Technology and Electrical Engineering (ICITEE) - JSCI (The Joint Symposium on Computational Intelligence)

## Multi-Modal Stock Model Comparison (comparison/)

This repository contains the implementation for our research paper comparing transformer architectures and classical baselines for multi-horizon stock return prediction. The active codebase lives in `comparison/` and implements a leakage-safe, multi-horizon stock prediction pipeline with caching, classical baselines, and deep models.Stock TFT: Temporal Fusion Transformer for Stock Price Prediction
